<template>
  <section class="todoapp">
    ...
    <div class="main">
      ...
      <ul class="todo-list">
        <li class="todo" v-for="todo in filteredTodos" :key="todo.index" :class="{completed: todo.completed, editing: todo === editing}">
          <div class="view">
    ...
    <footer class="footer" v-show="hasTodos">
      ...
      <button class="clear-completed" v-show="hasCompleted" @click="deletedCompleted">Supprimer les tâches finies</button>
    </footer>
  </section>
</template>
